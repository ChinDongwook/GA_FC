    ...
    for i, tab in enumerate(tabs):
        with tab:
            ...
            if name == "📞 연락처":
                ...
                st.table({
                    "부서 / 직함": ["센터장", "성남센터", "지원팀"],
                    "성명":       ["진동욱", "성남센터", "성남센터 Fax", "Mobil Fax"],
                    "내선번호":   ["010-5717-1402",   "031-722-2223",   "031-759-2225",   "0504-036-1402"],
                })
            else:
    ...
    with col_c:
        ...
        if submitted:
            valid_users = {
                ...
                "WA251028":   "WA251028", "WA240644":   "WA240644", "WA120528":   "WA120528", "WA211014":   "WA211014", 
                "WA181071":   "WA181071", "WA22113":   "WA22113", "WA220161":   "WA220161", "WA23093":   "WA23093",
                "WA221127":   "WA221127", "WA230121":   "WA230121", "WA220451":   "WA220451", "WA22014":   "WA22014",
                "WA200817":   "WA200817", "WA210654":   "WA210654", "WA201164S":   "WA201164S", "WA240714":   "WA240714",
                "WA231227":   "WA231227", "WA201055":   "WA201055", "WA230962":   "WA230962",
            }
...
def main_app():
    ...
    <div class="hero-container">
        <div class="hero-eyebrow">WASSET_SEUNGNAM CENTER</div>
    ...
    if selected_menu == "🏢 센터 소개":
        ...
        if is_logged_in:
            cards.extend([
                ...
                ("👥", "WASEET_AGIT 집단지성", "서비스 준비중입니다.", "https://w123.agit.io/home"),
                ("🏆", "우수사례 공유", "서비스 준비중입니다.", "")
            ])
