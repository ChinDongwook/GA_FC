...
# [핵심] 차트 타이틀 사이즈 축소용 CSS (기존 로직 유지)
st.markdown("""
    <style>
...
# --- [2] 핵심 계산 로직 함수 (오리지널 연 단위 산출 로직 유지) ---
...
fig_cum = px.area(df_cum, x="생존 나이", y=["납입 원금", "연금 누적 수익"], color_discrete_map={"납입 원금": "#E74C3C", "연금 누적 수익": "#2E86C1"})
